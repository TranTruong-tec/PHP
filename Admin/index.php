...
<body>
			...
			<div class="navbar-header">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Xin chào, 
						<?php 
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="category.php"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Bình Luận</a></li>
			<li role="presentation" class="divider"></li>
		</ul>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		...
		switch ($_GET["get_layout"]) {
			...
			case 'category':include_once './category.php';
				# code...
				break;
			case 'editcategory':include_once './editcategory.php';
				# code...
				break;
			// case 'addproduct':include_once './Sanpham/addproduct.php';
			// 	# code...
			// 	break;
